...
export const filtroPrecio = [
    ...
    { limIzq: 40, limDer: 60 },
    { limIzq: 60, limDer: 80 },
    { limIzq: 80, limDer: 100 },
    { limIzq: 100, limDer: 500}
]

export const filtroFragancia = [
    "Frutal",
    "Flores",
    "Citricos"
]
...
export const categories = [
    {item: "Christian Dior" , imgUrl: "img/categoriaCollar.jpg"},
    {item: "BVLGARI", imgUrl: "img/categoriaAnillo.jpg" },
    {item: "BURBERRY", imgUrl: "img/categoriaArete.jpeg"},
    {item: "GUCCI", imgUrl: "img/categoriaVaper.webp"}
]

export const cauroselItems = [
    {
        header: "",
